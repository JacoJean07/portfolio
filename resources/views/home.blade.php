    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 text-center text-lg-left">
          ...
          <h1 class="display-3 text-uppercase text-secondary mb-2" style="-webkit-text-stroke: 2px #ffffff;">
            {{ $user?->name }}</h1>
  ...
  <div class="container-fluid py-5" id="about">
    <div class="container">
      <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <h1 class="position-absolute text-uppercase text-secondary">About Me</h1>
      </div>
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6 py-2">
              <h6>Phone: <span class="text-secondary"><a href="tel:{{ $user?->phone }}">{{ $user?->phone }}</a></span>
              </h6>
            </div>
            <div class="col-sm-6 py-2">
              <h6>Email: <span class="text-secondary"><a
  ...
  <div class="container-fluid py-5" id="qualification">
    <div class="container">
      <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <h1 class="position-absolute text-uppercase text-secondary">Education & Expericence</h1>
      </div>
      <div class="row align-items-center">
        <div class="col-lg-6">
  ...
  <div class="container-fluid pt-5" id="service">
    <div class="container">
      <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <h1 class="position-absolute text-uppercase text-secondary">My Services</h1>
      </div>
      <div class="row pb-3">
        @foreach ($services as $service)
          <div class="col-lg-4 col-md-6 text-center mb-5">
            <div class="d-flex align-items-center justify-content-center mb-4">
              <i class="{{ $service->icon }} service-icon bg-secondary text-white mr-3"></i>
  ...
  <div class="container-fluid pt-5 pb-3" id="portfolio">
    <div class="container">
      <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <h1 class="position-absolute text-uppercase text-secondary">My Portfolio</h1>
      </div>
      <div class="row">
        ...
        @foreach ($portfolios as $portfolio)
          <div class="col-lg-12 col-md-12 mb-4 portfolio-item {{ $portfolio->category->name }}">
            <div class="position-relative overflow-hidden" style="width: 100%;">
              ...
              <iframe src="{{ $portfolio->project_url }}" width="100%" height="500" frameborder="0"
                allowfullscreen></iframe>
              <a target="_blank" href="{{ $portfolio->project_url }}"><button class="btn btn-primary btn-sm">View</button></a>
            </div>
          </div>
        @endforeach
      </div>
  ...
  <div class="container-fluid py-5" id="testimonial">
    <div class="container">
      <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <h1 class="position-absolute text-uppercase text-secondary">Clients Say</h1>
      </div>
  ...
  <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
    <div class="container text-center py-5">
      <div class="d-flex justify-content-center mb-4">
        <a target="_blank" class="btn btn-light btn-social mr-2" href="{{ $setting->github_url }}"><i
            class="fab fa-github"></i></a>
        <a target="_blank" class="btn btn-light btn-social mr-2" href="{{ $setting->fb_url }}"><i
            class="fa-brands fa-instagram"></i></a>
        <a target="_blank" class="btn btn-light btn-social mr-2" href="{{ $setting->linkedin_url }}"><i
      ...
      <p class="m-0">&copy; <a class="text-white font-weight-bold" href="#">JacoJean.pro</a>. All Rights
        Reserved. Designed by <a class="text-white font-weight-bold" target="_blank"
