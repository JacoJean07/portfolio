...
<head>
  ...
  <link rel="stylesheet" href="import/assets/css/a.css">
...
<body>
    <!-- boton para regresar -->
    <a href="{{ route('home') }}" style="text-decoration: none; color: red;">Regresar</a>
<div class="envlope-wrapper container">
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js'></script><script  src="import/assets/js/a.js"></script>
